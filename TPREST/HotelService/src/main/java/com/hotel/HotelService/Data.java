...
public class Data {
	...
	private String[] villes = {"Paris", "Montpellier", "Toulouse", "Nancy", "Nice", "Lyon", "Bordeaux"} ;
    @EventListener
    public void appReady(ApplicationReadyEvent event) {
    	...
    	cli.save(new Client(null, "Pierre", "Jean", "79652"));
    	...
    	cli.save(new Client(null, "Stanford", "Samantha", "77866"));
    	...
    	cli.save(new Client(null, "Freyer", "John", "68334"));
    	...
    	cli.save(new Client(null, "Stroychka", "Dimitri", "93303"));
    	...
    	cli.save(new Client(null, "Gauvin", "Matthieu", "86175"));
    	...
    	cli.save(new Client(null, "Trenfo", "Samuel", "81990"));
    	...
    	cli.save(new Client(null, "Desu", "Patrick", "84226"));
